(fn setup_packages [use]
  ...
  (use {1 :hrsh7th/vim-vsnip
        ...
        :setup (fn []
                 (vim.api.nvim_set_keymap :i :<C-Tab>
                                          ...
                                          {:expr true})
                 (vim.api.nvim_set_keymap :s :<C-Tab>
                                          "vsnip#jumpable(1)   ? '<Plug>(vsnip-jump-next)'      : '<C-Tab>'"
                                          {:expr true})
  ...
  (use {1 :hrsh7th/nvim-cmp
        :event :InsertEnter
        :requires [{1 :hrsh7th/cmp-vsnip :after :nvim-cmp}
  ...
  (use {1 :nvim-lua/plenary.nvim :module :plenary})
  (use {1 :kyazdani42/nvim-web-devicons :module :nvim-web-devicons})
